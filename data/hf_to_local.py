...
def download_file(repo_id: str, repo_type: str, filename: str, output_path: str, token: str | None = None):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download a file from Hugging Face dataset")
    ...
    download_file(repo_id=args.repo, repo_type="dataset",
                  filename=args.zip_filename, output_path=args.zip_filename,
                  token=args.token)
