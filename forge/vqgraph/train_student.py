...
def get_args():
    ...
    parser.add_argument(
        "--save_results",
        action="store_true",
        help="Set to True to save the loss curves, trained models, and min-cut loss for the transductive setting",
    )
    ...
    parser.add_argument("--teacher", type=str, default="SAGE", help="Teacher models")
    parser.add_argument("--student", type=str, default="MLP", help="Student models")
    parser.add_argument(
        "--num_layers", type=int, default=2, help="Student models number of layers"
    )
    parser.add_argument(
        "--hidden_dim",
        type=int,
        default=64,
        help="Student models hidden layer dimensions",
    )
...
def run(args):
    ...
    if args.save_results:
        ...
        # Model
        torch.save(model.state_dict(), output_dir.joinpath("models.pth"))
